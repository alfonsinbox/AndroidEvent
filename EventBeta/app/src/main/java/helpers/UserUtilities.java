...
public class UserUtilities {
    ...
    private static final String TAG = "UserUtilities";

    public static void getUserInfo(final Activity activity, final MobileServiceClient mClient, final ServiceFilterResponseCallback serviceFilterResponseCallback) {

        TokenCheck.checkToken(new ITokenCheckCallback() {
            @Override
            public void onSuccess() {
                List<Pair<String, String>> params = new ArrayList<>();

                List<Pair<String, String>> headers = new ArrayList<>();
                headers.add(Pair.create("X-ZUMO-AUTH", AuthUtilities.getLocalToken(Globals.PREFERENCE_USER_ACCESS_TOKEN, activity)));
...
//
    public static void getUsersFromStringFuture(final Context activity, final String query, final MobileServiceClient mClient, final ListenableFutureCreatedCallback listenableFutureCreatedCallback) {
        TokenCheck.checkToken(new ITokenCheckCallback() {
            @Override
            public void onSuccess() {
                List<Pair<String, String>> params = new ArrayList<>();
