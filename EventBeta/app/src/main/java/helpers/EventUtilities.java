...
public class EventUtilities {
    public static void getUserEvents(final Context activity, final MobileServiceClient mClient, final ServiceFilterResponseCallback serviceFilterResponseCallback) {
...
/*
    public static void getEventsForMap(final Context activity, final String latitude, final String longitude, final String within_radius, final MobileServiceClient mClient, final ServiceFilterResponseCallback serviceFilterResponseCallback) {
        ...
        IntentFilter intentFilter = new IntentFilter(Globals.ACTION_TOKEN_CHECK_CALLBACK_SUCCESS);
